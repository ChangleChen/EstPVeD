...
`dsi_studio --action=rec --source=sub-001_dwi.src.gz --cmd="[Step T2][Corrections][EDDY]" --method=7 --param0=1.25 --qsdr_reso=2 --check_btable=1 --thread_count=8 --dti_no_high_b=1 --template=0 --other_output=fa,ad,rd,md,iso,rdi,nrdi,tensor`.
